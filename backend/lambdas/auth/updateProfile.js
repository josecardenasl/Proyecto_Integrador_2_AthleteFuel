...
exports.handler = async (event) => {
  try {
    ...
    const { goals, weight, height, age, gender, timezone } = body;
    ...
    if (goals !== undefined) {
      ...
      expressionValues[":goals"] = goals.trim();
    }
    if (weight !== undefined) {
      updateParts.push("weight = :weight");
      expressionValues[":weight"] = Number(weight);
    }
    if (height !== undefined) {
      updateParts.push("height = :height");
      expressionValues[":height"] = Number(height);
    }
    if (age !== undefined) {
      updateParts.push("age = :age");
      expressionValues[":age"] = Number(age);
    }
    if (gender !== undefined) {
    ...
    if (timezone !== undefined) {
      ...
      expressionValues[":timezone"] = timezone;
    }
